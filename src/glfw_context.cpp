...
GLFWResizeCallbackfn GetResizeCallback() { return ResizeCallback; }
...
void Init(uint32_t resX, uint32_t resY) {
  ...
  g_window = glfwCreateWindow(resX, resY, "Dear ImGui GLFW+Vulkan example",
                              NULL, NULL);
...
GLFWwindow *GetWindow() { return g_window; }
} // namespace GLFW
} // namespace ExtImGui
